...
console.log(value);
  ...
  return <>
    ...
    <div className="md:w-1/2 w-full ">
      ...
      <p className="font-thin text-xl text-white/50 my-4">For more info, here`s my <a className='text-white underline decoration-[rgb(210,232,121)]' href="#">resume</a></p>
      <ul className='flex gap-5 mt-10'>
        ...
        <li><a href="#" className='text-[rgb(210,232,121)] hover:text-white transition-all'><Facebook/></a></li>
        <li><a href="#" className='text-[rgb(210,232,121)] hover:text-white transition-all'><Instagram/></a></li>
      </ul>
